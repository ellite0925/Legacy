  ...
  return (
    <>
      <div className="md:container mx-auto py-24">
        <div className="px-2 flex flex-col items-center border-[#D7D7D7] border-2 rounded-[32px] py-16 relative">
          ...
          <p className="mt-5 font-noto font-normal text-lg leading-7 text-[#636363]">Subscribe to our super-rare and exclusive drops & collectibles.</p>
          <div className="flex space-x-3 mt-9">
            <input className="bg-[#F7F9FB] rounded-[50px] pl-6 w-[300px]" type="text" placeholder="Enter your email" />
