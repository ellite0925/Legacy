  ...
  return (
    <>
      <div className="md:container mx-auto flex flex-col px-0 md:px-0">
        <div className="flex justify-between items-center mt-8 mb-8 px-2 md:px-0 flex-col sm:flex-row space-y-4 sm:space-y-0">
            ...
            <div className="space-x-6 items-center text-sm font-trispace font-normal leading-4 hidden xl:flex">
              <div className="flex items-center relative group">
                <div className='flex items-center cursor-pointer'>
                  <p className="mr-2 cursor-pointer">{t("Collection")}</p>
                  <img className="inline dark:hidden" src={down_arrow} />
                  <img className="hidden dark:inline" src={down_arrow_dark} />
                </div>
                <div className="absolute group-hover:block hidden bg-white dark:bg-[#313131] rounded-xl p-2 top-4 left-0 z-20 w-[200px] border-[0.5px] border-black border-opacity-10" style={{boxShadow: "0px 10px 15px 0px #0000000D, 0px 25px 37px 0px #0000001A"}}>
              ...
              <div className="flex items-center relative group">
                <div className='flex items-center cursor-pointer'>
                  <p className="mr-2 cursor-pointer">{t("Media")}</p>
                  <img className="inline dark:hidden" src={down_arrow} />
                  <img className="hidden dark:inline" src={down_arrow_dark} />
                </div>
                <div className="absolute group-hover:block hidden bg-white dark:bg-[#313131] rounded-xl p-2 top-4 left-0 z-20 w-[200px] border-[0.5px] border-black border-opacity-10" style={{boxShadow: "0px 10px 15px 0px #0000000D, 0px 25px 37px 0px #0000001A"}}>
